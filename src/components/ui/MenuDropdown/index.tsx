...
export default function MenuDropdown() {
    ...
    return (
        <>
            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" onClick={() => setShowMenu(!showMenu)}>
            ...
            <ul className={`${!showMenu ? "hidden ": ""} py-2 space-y-2`}>
                <li>
